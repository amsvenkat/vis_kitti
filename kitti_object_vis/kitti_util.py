...
def compute_box_3d(obj, P):
    ...
    #     corners_3d[1, :] = corners_3d[1, :] #+ h/2 + obj.t[1] - obj.t[1]
...
def draw_projected_box3d(image, qs, color=(0, 255, 0), thickness=2):
    ...
    points = np.array([(qs[0, 0], qs[0, 1]), (qs[1, 0], qs[1, 1]),(qs[5, 0], qs[5, 1]),(qs[4, 0], qs[4, 1])], np.int64)
    
    #cv2.fillConvexPoly(image, points, 0, cv2.LINE_8)
    return image
