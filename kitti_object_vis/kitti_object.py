...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split="training", args=None):
        ...
        # self.image_dir = "/export/amsvenkat/project/3d-multi-agent-tracking/data/train_jan/image/custom_data"
        # self.label_dir = "/export/amsvenkat/project/3d-multi-agent-tracking/data/train_jan/label"
        # self.calib_dir = "/export/amsvenkat/project/3d-multi-agent-tracking/data/train_jan/calib"

        self.image_dir = "/export/amsvenkat/project/data/train_v3/image_3"
        self.label_dir = "/export/amsvenkat/project/data/train_v3/label_3"
        self.calib_dir = "/export/amsvenkat/project/data/train_v3/calib"
